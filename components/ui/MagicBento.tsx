...
const cardData: BentoCardProps[] = [
    {
        ...
        description:
            "Recognized at the national level for innovative solutions and impactful projects.",
    },
    {
        icon: <ShieldCheck className="w-8 h-8" />,
        title: "Oracle Cloud Infrastructure 2025 Foundations Associate",
        description:
            "Certified in cloud fundamentals, demonstrating knowledge in cloud computing.",
    },
    {
        icon: <Star className="w-8 h-8" />,
        title: "Selected Innovator – Future Founders Program 1.0, RTIH ",
        description:
            "Chosen for an elite program nurturing startup ideas and entrepreneurial skills.",
    },
    {
        icon: <BookOpen className="w-8 h-8" />,
        title: " Coursera – 101 DSA",
        description:
            "Completed a Data Structures & Algorithms course, enhancing programming and problem-solving skills.",
    },
    {
        icon: <Trophy className="w-8 h-8" />,
        title: "Winner – Mind Sprint 2025 National Hackathon",
        description:
            "Secured first place in a national wide competition showcasing problem-solving skills.",
    },
    {
        icon: <Medal className="w-8 h-8" />,
        title: "Top 1% in TCS Code Vita Screening Round (2025)",
        description:
            "Achieved top percentile in a competitive coding challenge, proving coding proficiency.",
    },
];
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-2 p-20 max-md:p-0">
                    {cardData.map((card, index) => {
                        const baseClassName = `
  card relative flex flex-col justify-between w-full min-h-[180px] sm:min-h-[200px] lg:min-h-[220px] p-5 rounded-2xl border font-light overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 ${isDark
